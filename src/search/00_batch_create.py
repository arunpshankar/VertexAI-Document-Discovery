...
data = {'providedUriPattern': '*.hsbc.com/*', 'type': 'INCLUDE', 'exactMatch': True}
#data = {'targetSite': '*.hsbc.com/*', 'type': 'INCLUDE', 'exactMatch': True}

data = {
  "requests": [{'parent': f'projects/{PROJECT_ID}/locations/global/collections/default_collection/dataStores/{DATA_STORE_ID}/siteSearchEngine', 'targetSite': {'providedUriPattern': '*.sc.com/*', 'type': 'INCLUDE', 'exactMatch': True}}, {'parent': f'projects/{PROJECT_ID}/locations/global/collections/default_collection/dataStores/{DATA_STORE_ID}/siteSearchEngine', 'targetSite': {'providedUriPattern': '*.iob.in/*', 'type': 'INCLUDE', 'exactMatch': True}}]
  }
